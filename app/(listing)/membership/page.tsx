            ...
            <div className='lg:grid grid-cols-5 md:mt-[-400px] z-50'>
                ...
                <div className="bg-white lg:shadow-xl lg:p-20 p-10 lg:col-span-3">
                    ...
                    <div className='md:text-[18px] text-gray-600'>
                        ...
                        <ul className='my-3 ml-6 marker:text-blue-800'>
