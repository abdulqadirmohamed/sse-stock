...
const page = () => {
  return (
    <div className='h-screen relative'>
      ...
      <div className='shadow-md absolute mb-12 right-0 top-48 bg-white w-2/3 p-10 h-fit'>
        <h1 className='text-2xl font-bold mb-6 uppercase'>About us</h1>
        <div className='text-[20px] pr-10 text-gray-600'>
